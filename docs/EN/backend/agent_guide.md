...
> **Documentation for AI Agents** to understand project structure, coding standards, and architecture patterns.
...
**Core Principle**: Business logic is independent of infrastructure.
...
**Example**:
```python
# Core service unaware of infrastructure
